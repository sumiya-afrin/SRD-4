<?php 
    ...
    if(isset($_GET['id'])){
        $id = $_GET['id'];
        $sql = "SELECT DISTINCT semester FROM marks WHERE student_id = $id";
        ...
        $crs = $_GET['c'];
        $sql = "SELECT DISTINCT student_id FROM marks WHERE course_id = '$crs'";
    ...
    function seeker($sem, $uid){
        ...
        $sql;
        if($sem!="null"){
            $sql = "SELECT * FROM marks WHERE student_id = $uid AND semester = '$sem'";
        }else{
            $sql = "SELECT * FROM marks WHERE student_id = $uid";
        }
    ...
    function seeker2($crs, $uid){
        require 'mysql.php';
        $sql = "SELECT * FROM marks WHERE student_id = $uid AND course_id = '$crs'";
